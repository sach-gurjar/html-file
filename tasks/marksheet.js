...
function call3() {
  ...
  var o = "<table border='1' width='60%' cellspacing='0' cellpadding='5'>";
      ...
      o +="<tr><th>Paper Code</th><th>Subject</th><th>Min marks</th><th>max marks</th><th>Marks Obtained</th><th>Remark</th></th></tr>"
      ...
      o += `<tr bgcolor='#9CAA82' ><th colspan ='2'><b>Total marks = ${tm} </b></th><th  colspan='2'><b>Percentage= ${pr} </b></th><th colspan='2'><b>Division= ${dd} </b></th></tr></table>`;
